    ...
    <>
      ...
      {gameOver && (
        ...
        >
          ...
          <Share text={`Score: ${score} ${url} #Openxai #Base @OpenxAINetwork @Base Check out my new app built with the OpenxAI #MiniAppFactory! Try it out here > LINK TO THE APP`} />
          <button
            onClick={() => {
              setGameOver(false);
              setScore(0);
